...
seq = torch.randint(0, 20000, (16, 1024))
mask = torch.ones(16, 1024).bool()

logits = model(seq, mask = mask) # (16, 1024, 20000)
logits.shape

seq = torch.randint(0, 20000, (16, 887))
mask = torch.ones(16, 887).bool()

logits = model(seq, mask = mask) # (16, 887, 20000)
logits.shape
